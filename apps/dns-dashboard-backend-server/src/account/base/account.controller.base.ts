...
import { DomainFindManyArgs } from "../../domain/base/DomainFindManyArgs";
...
export class AccountControllerBase {
  ...
  @common.Get("/:id/domains")
  @ApiNestedQuery(DomainFindManyArgs)
  async findDomains(
    @common.Req() request: Request,
    @common.Param() params: AccountWhereUniqueInput
  ): Promise<Domain[]> {
    const query = plainToClass(DomainFindManyArgs, request.query);
    const results = await this.service.findDomains(params.id, {
      ...query,
      select: {
        account: {
          select: {
  ...
  @common.Post("/:id/domains")
  async connectDomains(
    @common.Param() params: AccountWhereUniqueInput,
    @common.Body() body: DomainWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      domains: {
        connect: body,
